	...
	<div class="ctf-input-field ctf-input-field-radio-button ctf-input-field-text-align  clearfix">
		...
		<# if( ! _.isEmpty(data.choices['left']) && data.choices['left'] != 0 ){ #>
		<label>
		...
		<# } #>
		<# if( ! _.isEmpty(data.choices['center']) && data.choices['center'] != 0 ){ #>
		<label>
		...
		<# } #>
		<# if( ! _.isEmpty(data.choices['right']) && data.choices['right'] != 0 ){ #>
		<label>
		...
		<# } #>
		<# if( ! _.isEmpty(data.choices['justify']) && data.choices['justify'] != 0 ){ #>
		<label>
